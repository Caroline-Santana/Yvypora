...
class SalesHistory : ComponentActivity() {
        ...
        Column() {
            ...
            )
            {
                ...
                Column(
                    ...
                    Row() {
                        ListOfMarketerCardSale(marketers = listMarketerCardSale)
...
@Composable
fun ListOfMarketerCardSale(marketers: List<MarketerCard>) {
    LazyColumn() {
        items(marketers) { client -> CardClient(marketer = client) }
...
val listMarketerCardSale = listOf<MarketerCard>(
    MarketerCard(
...
@Composable
fun CardClient(marketer: MarketerCard) {
